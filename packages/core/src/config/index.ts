...
import ClassUpdater from '../v2/schema/classUpdater.js';
import { ClassGetter, PropertyCreator, ShardUpdater } from '../v2/schema/index.js';
import ShardsGetter from '../v2/schema/shardsGetter.js';
import VectorAdder from '../v2/schema/vectorAdder.js';
